...
class Bot {
    ...
    static checkMention(message) {
        ...
        const LexingtonRegex = /\@(L|l)exington/;

        if(messageText && (allRegex.test(messageText) || everyoneRegex.test(messageText) || LexingtonRegex.test(messageText))) {
            return true;
        }
    ...
    static checkMessage(message) {
        ...
        const membersRegex = /^\/members$/;
        const photoDriveRegex = /^\/(p|P)hoto (d|D)rive$/;
        ...
        } else if(messageText && galleryRegex.test(messageText)) {
            return 'https://photos.app.goo.gl/bAXAwv4jRJ7rJqwb7'
        } else if(messageText && membersRegex.test(messageText)) {
            return 'https://photos.app.goo.gl/kmDbw957xqzvFbjj8'
        } else if(messageText && photoDriveRegex.test(messageText)) {
            return 'https://photos.app.goo.gl/pAyAJHdQ1eJwM74A7'
    ...
    static sendMention(isLex) {
        ...
        if(isLex) {
            ...
            userids = ["19542518", "19805360", "23757907", "23757906", "45258463", "68505902", "36989251", "920648", "7282458", "21561546", "22820263", "22939688", "22820261", "8209125", "5872179", "21300347"]
        } else {
            messageText = "Everyone, get in here!";
            userids = ["19542518", "19805360", "3411029", "24875384", "31510906", "23757907", "23757906", "23757908", "6085493", "45258463", "68505902", "25616793", "30500658", "36989251", "920648", "7282458", "21561546", "22820263", "22939688", "20896823", "22820261", "8209125", "5872179", "24365259", "21300347"];
        }
